        ...
        <div className="Services-section">
            ...
            <header className="Services-header">
                <div className="Services-header-inner">
                    <h1 className='servicies-h1'>Our Services</h1>
                    <h2 className='servicies-h2'>Crafting Visual Stories for the Digital Age</h2>
                    <h3>
            ...
            <div className="pre-production-section">
                <div className="pre-production-container">
                    ...
                    <div className="pre-production-items">
                        <div className="pre-production-item-img"> </div>
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Scripting</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Storyboarding</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Casting</div>
                            <div className="pre-production-item-details">
                                We handpick talent from a curated pool of over 500 professional actors and models, 
             ...
             <div className="production-section">
                <div className="pre-production-container">
                    ...
                    <div className="pre-production-items">
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Filming</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="production-item-img"> </div>

                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Live Event Coverage</div>
                            <div className="pre-production-item-details">
                                From conferences to concerts, we provide multi-angle, 
                                real-time event filming with professional crew and 
                                gear — ensuring your moments are captured with clarity, 
                                depth, and cinematic impact.
                            </div>
                        </div>

                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Directing</div>
                            <div className="pre-production-item-details">
             ...
             <div className="pre-production-section">
                <div className="pre-production-container">
                    ...
                    <div className="pre-production-items">
                        <div className="post-production-item-img"> </div>
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Editing</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">VFX</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Sound Design</div>
                            <div className="pre-production-item-details">
                        ...
                        <div className="pre-production-item">
                            <div className="pre-production-item-title">Color Grading</div>
                            <div className="pre-production-item-details">
